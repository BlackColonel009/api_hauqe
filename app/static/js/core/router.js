...
const routes = Object.freeze({
  ...
  "collecte-form": { view: "/views/collecte-form", script: "/static/js/collecte-form.js?v=20260921-1", title: "Fiche de collecte" },
  validations: { view: "/views/validations", script: "/static/js/validations.js", title: "Validation des collectes" },
  "validation-detail": { view: "/views/validation-detail", script: "/static/js/validation-detail.js?v=20260921-1", title: "Validation hiérarchisée" },
  controle: { view: "/views/controle", script: "/static/js/controle.js", title: "Grille de contrôle" },
  "controle-detail": { view: "/views/controle-detail", script: "/static/js/controle-detail.js?v=20260921-2", title: "Contrôle FUCCS" },
  scoring: { view: "/views/scoring", script: "/static/js/scoring.js?v=20260921-6", title: "Scoring et conformité" },
  ...
  referentiels: { view: "/views/referentiels", script: "/static/js/referentiels.js?v=20260921-1", title: "Référentiels" },
  "zones-administratives": { view: "/views/zones-administratives", script: "/static/js/zones-administratives.js?v=20260921-1", title: "Zones administratives" },
  "regles-codification": { view: "/views/regles-codification", script: "/static/js/regles-codification.js?v=20260921-1", title: "Règles et codification" },
  ...
  "verification-detail": { view: "/views/verification-detail", script: "/static/js/verification-detail.js?v=20260921-1", title: "Dossier de vérification" },
  integrations: { view: "/views/integrations", script: "/static/js/integrations.js", title: "Intégration BNEC" },
  "integration-detail": { view: "/views/integration-detail", script: "/static/js/integration-detail.js?v=20260921-1", title: "Dossier d’intégration BNEC" },
  infc: { view: "/views/infc", script: "/static/js/infc.js?v=20260921-6", title: "INFC" },
  "classement-sncc": { view: "/views/classement-sncc", script: "/static/js/classement-sncc.js?v=20260921-1", title: "Classement SNCC" },
